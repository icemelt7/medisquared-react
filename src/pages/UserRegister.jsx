                    ...
                    <div className="form-body">
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane" id="tab2">
                          <h3 className="block">Personal details</h3>
                          <div className="form-group">
                            <label className="control-label col-md-3">Fullname
                              <span className="required" aria-required="true"> * </span>
                            </label>
                            <div className="col-md-4">
                          ...
                          <div className="form-group">
                            ...
                            <div className="col-md-4">
                              <div className="radio-list">
                                <label>
                                  <input type="radio" name="gender" defaultValue="M" data-title="Male" /> Male </label>
                                <label>
                                  <input type="radio" name="gender" defaultValue="F" data-title="Female" /> Female </label>
                              </div>
                          ...
                          <div className="form-group">
                            ...
                            <div className="col-md-4">
                              ...
                              <span className="help-block"> Provide your phone number </span>
                            </div>
                          </div>
                          <div className="form-group">
                          ...
                          <div className="form-group">
                            ...
                            <div className="col-md-4">
                              ...
                              <span className="help-block"> Provide your city or town </span>
                            </div>
                          </div>
                          <div className="form-group">
